...
app.initializers.add("adkhomepage", function () {
  ...
  app.extensionData["for"]('webbinaro-adkhomepage').registerSetting({
    setting: 'adkhomepage.discussion_button',
    // This is the key the settings will be saved under in the settings table in the database.
    label: app.translator.trans('adkhomepage.admin.settings.discussion_button'),

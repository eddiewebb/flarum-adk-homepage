...
var BlogSettings = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.content = function content() {
    ...
    }, this.blogCategories.length === 0 ? app.translator.transChoice("v17development-flarum-blog.admin.settings.no_categories_selected") : app.translator.transChoice("v17development-flarum-blog.admin.settings.selected_category_count", this.blogCategories.length, {

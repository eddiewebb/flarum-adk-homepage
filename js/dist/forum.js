...
/* harmony import */ var _utils_tooltip__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/tooltip */ "./src/forum/utils/tooltip.js");
...
/* harmony import */ var _components_ForumNav__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/ForumNav */ "./src/forum/components/ForumNav.js");
/* harmony import */ var flarum_utils_string__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! flarum/utils/string */ "flarum/utils/string");
/* harmony import */ var flarum_utils_string__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(flarum_utils_string__WEBPACK_IMPORTED_MODULE_11__);
...
var AdkHomepage = /*#__PURE__*/function (_Page) {
  ...
  _proto.reloadData = function reloadData() {
    ...
    app.store.find("discussions", {
      ...
      sort: "-createdAt",
      limit: 3
    }).then(function (featuretag) {
      _this.featuretag = featuretag.slice(0, 3);
      app.store.find("discussions", {
        filter: {
          q: q
        },
        ...
        jQuery.merge(_this.featuretag, featured.slice(0, 3 - _this.featuretag.length));
        _this.featured = _this.featuretag;
        app.store.find("discussions", {
          sort: "-lastPostedAt",
          include: "lastPost"
  ...
  _proto.show = function show(articles) {
    ...
    this.posts = articles; // Set pagination
  ...
  _proto.title = function title() {
    if (!m.route.param("slug")) {
      return m("h2", null, app.translator.trans("adkhomepage.forum.featured"));
    }

    var tag = app.store.all("tags").filter(function (tag) {
      return tag.slug() === m.route.param("slug");
    });
    return m("h2", null, tag && tag[0] && tag[0].name(), m("small", null, " ", "-", " ", m(flarum_components_Link__WEBPACK_IMPORTED_MODULE_7___default.a, {
      href: app.route("blog")
    }, app.translator.trans("v17development-flarum-blog.forum.return_to_overview"))));
  };

  _proto.startDiscussion = function startDiscussion() {
    ...
    return flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      ...
      onclick: function onclick() {
        return new Promise(function (resolve, reject) {
          if (app.session.user) {
            app.composer.load(flarum_components_DiscussionComposer__WEBPACK_IMPORTED_MODULE_4___default.a, {
              user: app.session.user
            });
            app.composer.show();
            return resolve(app.composer);
          } else {
            app.modal.show(flarum_components_LogInModal__WEBPACK_IMPORTED_MODULE_5___default.a);
            return reject();
          }
        });
      },
  ...
  */
  ...
  _proto.isFeatured = function isFeatured(article) {
    if (!article.tags()) {
      return false;
    }
  ...
  _proto.view = function view() {
    ...
    return m("div", {
    ...
    }), !this.isLoading && this.featured.length >= 0 && this.featured.map(function (article) {
      ...
      var contentLink = _this3.isFeatured(article) ? app.route("discussion", {
        id: "" + article.slug()
      ...
      return m(flarum_components_Link__WEBPACK_IMPORTED_MODULE_7___default.a, {
        ...
        config: _utils_tooltip__WEBPACK_IMPORTED_MODULE_8__["default"].bind(_this3),
      ...
      var blogImage = article.lastPostedUser() && article.lastPostedUser().avatarUrl() ? "url(" + article.lastPostedUser().avatarUrl() + ")" : defaultImage;
      var isSized = article.blogMeta() && article.blogMeta().isSized();
      var summary = article.lastPost() && article.lastPost().contentPlain() ? Object(flarum_utils_string__WEBPACK_IMPORTED_MODULE_11__["truncate"])(article.lastPost().contentPlain(), 140) : "";
      return m(flarum_components_Link__WEBPACK_IMPORTED_MODULE_7___default.a, {
    ...
    }), !this.isLoading && this.posts.length > 0 && this.hasMore === null && m("p", {
      className: "FlarumBlog-reached-end"
    }, app.translator.trans("adkhomepage.forum.no_more_discussions")), !this.isLoading && this.featured.length === 0 && this.posts.length === 0 && m("p", {
      className: "FlarumBlog-reached-end"
      ...
      className: "Sidebar"
    }, this.startDiscussion(), m(_components_BlogCategories__WEBPACK_IMPORTED_MODULE_6__["default"], null), m(_components_ForumNav__WEBPACK_IMPORTED_MODULE_10__["default"], null)))));
  };

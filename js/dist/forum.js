...
var AdkHomepage = /*#__PURE__*/function (_Page) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      var summary = article.blogMeta() && article.blogMeta().summary() ? article.blogMeta().summary() : Object(flarum_utils_string__WEBPACK_IMPORTED_MODULE_9__["truncate"])(article.lastPost().contentPlain(), 140);
      return m(flarum_components_Link__WEBPACK_IMPORTED_MODULE_5___default.a, {
